...
/// ISO2 Country Code to Continent Code fetcher
class Continent {
  String targetURL;
  Continent({this.targetURL: 'http://country.io/continent.json'});

  /// Fetches an iso2 country code to iso2 continent code mapping from country.io
